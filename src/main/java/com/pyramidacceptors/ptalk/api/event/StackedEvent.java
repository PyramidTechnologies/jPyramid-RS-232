...
/**
 * Raised when slave signals a Stacked event<br>
 * {@link Events#Stacked}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class StackedEvent extends PTalkEvent {
    private static final long serialVersionUID = 1L;

    /**
     * Raised when slave signals a Stacked event
     ...
     */    
    public StackedEvent(Object source, BillNames billName, 
     ...
     */
    public StackedEvent(PTalkEvent event) {
