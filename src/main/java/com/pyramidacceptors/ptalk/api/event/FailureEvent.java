...
/**
 * Raised when slave raises a Failure event<br>
 * {@link Events#Failure}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class FailureEvent extends PTalkEvent {
    private static final long serialVersionUID = 1L;

    /**
     * Raised when slave raises a Failure event
     ...
     */    
    public FailureEvent(Object source, BillNames billName, 
     ...
     */
    public FailureEvent(PTalkEvent event) {
