...
/**
 * Raised when slave raises a PowerUp event<br>
 * {@link Events#PowerUp}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class PowerUpEvent extends PTalkEvent {
    private static final long serialVersionUID = 1L;

    /**
     * Raised when slave raises a PowerUp event
     ...
     */    
    public PowerUpEvent(Object source, BillNames billName, 
     ...
     */
    public PowerUpEvent(PTalkEvent event) {
