...
/**
 * Raised when slave enters the returning state<br>
 * {@link Events#Returning}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class ReturningEvent extends PTalkEvent{
    private static final long serialVersionUID = 1L;

    /**
     * Raised when slave enters the returning state
     ...
     */    
    public ReturningEvent(Object source, BillNames billName, 
     ...
     */
    public ReturningEvent(PTalkEvent event) {
