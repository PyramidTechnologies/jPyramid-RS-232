...
/**
 * Raised when slave raises a Cassette Missing event<br>
 * {@link Events#BillCasetteRemoved}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class CasseteMissingEvent extends PTalkEvent {
    private static final long serialVersionUID = 1L;
    
    /**
     * Raised when slave raises a Cassette Missing event
     ...
     */
    public CasseteMissingEvent(Object source, BillNames billName, 
     ...
     */
    public CasseteMissingEvent(PTalkEvent event) {
