...
/**
 * Raised when slave raises a Bill Jammed Event event<br>
 * {@link Events#BillJammed}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class BillJammedEvent extends PTalkEvent {
    private static final long serialVersionUID = 1L;

    /**
     * Raised when slave raises a Bill Jammed Event event
     * @param source origin the event
     * @param billName is the name of the bill credited or invalid if non-credit event
     ...
     */    
    public BillJammedEvent(Object source, BillNames billName, 
     ...
     */
    public BillJammedEvent(PTalkEvent event) {
