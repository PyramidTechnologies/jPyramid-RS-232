...
/**
 * Raised when slave raises an Invalid Message event<br>
 * {@link Events#InvalidCommand}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class InvalidMessageEvent extends PTalkEvent {
    private static final long serialVersionUID = 1L;

    /**
     * Raised when slave raises an Invalid Message event
     ...
     */    
    public InvalidMessageEvent(Object source, BillNames billName, 
     ...
     */
    public InvalidMessageEvent(PTalkEvent event) {
