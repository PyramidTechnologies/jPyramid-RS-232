...
/**
 * Raised when slave raises a Cashbox Full event<br>
 * {@link Events#StackerFull}
 * @author <a href="mailto:cory@pyramidacceptors.com">Cory Todd</a>
 */
public class StackerFullEvent extends PTalkEvent {
    private static final long serialVersionUID = 1L;
    
    /**
     * Raised when slave raises a Cashbox Full event
     ...
     */
    public StackerFullEvent(Object source, BillNames billName, 
     ...
     */
    public StackerFullEvent(PTalkEvent event) {
